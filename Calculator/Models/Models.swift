...
protocol APIClient {
    ...
    func fetchPost(_ url:String, _ method:String, _ urlData: String , _ completion: @escaping([String:String]?)-> Void)
...
extension APIClient {
    ...
    func fetchPost(url:String, method:String, urlData: Data , completion: @escaping([String:String]?)-> Void)  {
        let urlFind = URL(string:url)
        var request = URLRequest(url:urlFind!)
        request.httpMethod = method
        request.httpBody = urlData
